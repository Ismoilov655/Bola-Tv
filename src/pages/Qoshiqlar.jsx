        ...
        <main className='bg-gradient-to-b from-white to-green-100 pb-16 md:py-10'>
            <div className='mb-5'>
                            <div className='relative w-full'>
                                <img className='w-full h-36 md:h-56' src={song} alt="" />
            ...
            <section className='hidden sm:block w-full max-w-7xl mx-auto px-5 mb-8 md:mb-10'>
                <h2 className='text-lg text-red-800 decoration-blue-800 underline underline-offset-8 mb-5 md:text-2xl md:mb-10'>O'zbekcha qo'shiqlar</h2>
            ...
            <section className='hidden sm:block w-full max-w-7xl mx-auto px-5 mb-8 md:mb-10'>
                <h2 className='text-lg text-red-800 decoration-blue-800 underline underline-offset-8 mb-5 md:text-2xl md:mb-10'>Inglizcha qo'shiqlar</h2>
                <div className='grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-3 md:gap-y-5'>
